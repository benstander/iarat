...
const ytdl = youtubedl.create(process.env.YTDL_INSTALL_PATH || '');
...
// import youtubedl from 'youtube-dl-exec';
// import { spawn } from 'child_process';
// import { transcribeAudioWithGroq } from '@/lib/groqSpeechToText';
...
//       // IMPORTANT PART
//       transcribeAudioWithGroq(monoAudioPath);
